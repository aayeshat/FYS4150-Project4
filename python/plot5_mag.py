...
e_ordered = np.loadtxt("../out/data/magnetization_T1.0_ordered_problem5.txt", dtype="double", usecols = (0), unpack = True, skiprows = 0)
e_unordered = np.loadtxt("../out/data/magnetization_T1.0_unordered_problem5.txt", dtype="double", usecols = (0), unpack = True, skiprows = 0)
...
plt.savefig("../out/5a_T1.0_Mag.pdf")
