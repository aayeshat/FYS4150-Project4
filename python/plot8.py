...
plt.figure()
plt.plot(T, exp_E_unordered_20, label="L20", color="b")
plt.plot(T, exp_E_unordered_40, label="L40", color="g")
plt.plot(T, exp_E_unordered_80, label="L80", color="r")
plt.plot(T, exp_E_unordered_100, label="L100", color="k")
...
plt.figure()
plt.plot(T, exp_M_unordered_20, label="L20", color="b")
plt.plot(T, exp_M_unordered_40, label="L40", color="g")
plt.plot(T, exp_M_unordered_80, label="L80", color="r")
plt.plot(T, exp_M_unordered_100, label="L100", color="k")
